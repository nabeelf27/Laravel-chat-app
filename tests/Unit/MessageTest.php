...
use nabeelfarooqi\Chat\Tests\Helpers\Models\Bot;
use nabeelfarooqi\Chat\Tests\Helpers\Models\Client;
...
class MessageTest extends TestCase
{
    ...
    {
        $this->app['config']->set('nabeelfarooqi_chat.sender_fields_whitelist', [
            'name', 'bot_id',
        ]);
