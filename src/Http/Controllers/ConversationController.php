...
namespace nabeelfarooqi\Chat\Http\Controllers;

use Chat;
use Exception;
use Illuminate\Contracts\Routing\ResponseFactory;
use Illuminate\Http\Response;
use nabeelfarooqi\Chat\Exceptions\DeletingConversationWithParticipantsException;
use nabeelfarooqi\Chat\Http\Requests\DestroyConversation;
use nabeelfarooqi\Chat\Http\Requests\StoreConversation;
use nabeelfarooqi\Chat\Http\Requests\UpdateConversation;
...
class ConversationController extends Controller
{
    ...
    {
        if ($conversationTransformer = config('nabeelfarooqi_chat.transformers.conversation')) {
