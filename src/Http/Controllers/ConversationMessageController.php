...
use Chat;
use nabeelfarooqi\Chat\Http\Requests\ClearConversation;
use nabeelfarooqi\Chat\Http\Requests\DeleteMessage;
use nabeelfarooqi\Chat\Http\Requests\GetParticipantMessages;
use nabeelfarooqi\Chat\Http\Requests\StoreMessage;
...
class ConversationMessageController extends Controller
{
    ...
    {
        if ($messageTransformer = config('nabeelfarooqi_chat.transformers.message')) {
