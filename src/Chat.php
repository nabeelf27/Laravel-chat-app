...
use nabeelfarooqi\Chat\Models\MessageNotification;
use nabeelfarooqi\Chat\Services\ConversationService;
use nabeelfarooqi\Chat\Services\MessageService;
use nabeelfarooqi\Chat\Traits\SetsParticipants;
...
class Chat
{
    ...
    {
        return config('nabeelfarooqi_chat.broadcasts');
    }

    public static function sentMessageEvent()
    {
        return config('nabeelfarooqi_chat.sent_message_event');
    }

    public static function senderFieldsWhitelist()
    {
        $fields = config('nabeelfarooqi_chat.sender_fields_whitelist', []);
